...
call build.bat
call cd %~dp0
call aws s3 cp ..\dist\mapsuite-vectormap.js s3://cdnorigin.thinkgeo.com/vectormap-js/%newversion%/
call aws s3 cp ..\dist\mapsuite-vectormap-dev.js s3://cdnorigin.thinkgeo.com/vectormap-js/%newversion%/
call aws s3 cp ..\dist\mapsuite-vectormap.css s3://cdnorigin.thinkgeo.com/vectormap-js/%newversion%/
