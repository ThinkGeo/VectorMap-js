const menuData = [{
    ...
    styleName: 'Base Maps',
    subitems: [{
        comments:"This is the sample description showing what's the purpose of the sample and what functionality of vectormapjs we used and how to extend it to others",
