...
setLayerSourceEventHandlers(baseLightLayer);
setLayerSourceEventHandlers(baseDarkLayer);
setLayerSourceEventHandlers(baseAerialLayer);
setLayerSourceEventHandlers(baseTransparentLayer);
