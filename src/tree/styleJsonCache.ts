import { StyleJsonCacheItem } from "./styleJsonCacheItem";
import { Tree } from "./tree";
import { TreeNode } from "./treeNode";
import { GeoTextStyle } from "../style/geoTextStyle";

export class StyleJsonCache {
    private geoStyleGroupByZoom: any[];

    styleJson: any;
    geoStyles: any;
    geoTextStyleInfo:any;
    ...
    add(zoom: number, dataLayerName: string, tree: Tree<StyleJsonCacheItem>) {
