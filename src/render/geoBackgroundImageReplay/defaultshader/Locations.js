/**
 * @module ol/render/webgl/geoBackgroundImageReplay/defaultshader/Locations
 */
...
export var Locations = function(gl, program) {
   ...
   * @type {WebGLUniformLocation}
   */
  this.u_projectionTexCoordMatrix = gl.getUniformLocation(
    program, ol.DEBUG_WEBGL ? 'u_projectionTexCoordMatrix' : 'e');
  ...
  this.u_zIndex = gl.getUniformLocation(
    ...
    this.u_image = gl.getUniformLocation(
        program, ol.DEBUG_WEBGL ? 'u_image' : 'h');
