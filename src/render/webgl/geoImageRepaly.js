...
export class GeoImageReplay extends ImageReplay {
  constructor(tolerance, maxExtent, declutterTree){
   ...
   drawLineStringImage(geometry, feature, frameState, declutterGroup) {
    var offset = 0;
    var stride = 2;
    ...
    if (width * 4 <= pathLength) {  
        ...
        for (var len = 0; len < pointArray.length; len++) {
            ...
            let parts =ol.geom.flat.textpath.imagelineString(lineStringCoordinates, offset, end, 2, width, startM, resolution);
