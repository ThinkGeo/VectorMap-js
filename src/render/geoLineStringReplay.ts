...
export class GeoLineStringReplay extends ((<any>ol).render.webgl.LineStringReplay as { new(tolerance: number, maxExtent: any) }) {
    ...
    public replay(context, center, resolution, rotation, size, pixelRatio, opacity, skippedFeaturesHash,
        ...
        // projectionMatrix[0] = parseFloat(projectionMatrix[0].toPrecision(9));
        // projectionMatrix[3] = parseFloat(projectionMatrix[3].toPrecision(9));
        // projectionMatrix[0] = 0.000005379385093206958;// false
        //                       0.0000029923752394051515;// true
        //                       0.0000030424801271347266; false
        //                       0.0000030255930959017864

        // projectionMatrix[3] = 0.000005893092138143839;
        //                       0.000005893092138143839;    
        //                       0.000005893092138143839;                              
